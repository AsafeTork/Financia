...
async function captureAndLog(page, label) {
  ...
  try {
    // nosemgrep: javascript.lang.security.audit.path-traversal.path-join-resolve-traversal.path-join-resolve-traversal - label is generated by the local audit flow
