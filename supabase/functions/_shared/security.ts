// Shared security utilities - input validation, sanitization, rate limiting, caching
...
export async function cacheGet(
  ...
  try {
    ...
    const res = await admin.from('ai_cache')
      .select('response')
      .eq('scope', 'cache')
