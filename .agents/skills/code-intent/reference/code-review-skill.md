...
description: |
  Comprehensive code review guidance for the Financia stack (React 18 + Vite, Dexie
  offline-first, Supabase, Stripe, Tailwind, Vitest) plus React 19, Vue 3, Angular 17+,
  Svelte 5, Rust, TypeScript, Java, PHP, Python, Go, C#/.NET, Kotlin, Swift, and more.
...
Consult the matching detailed guide based on the code language under review:
