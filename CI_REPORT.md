...
**Gerado:** 2026-08-07 20:27 UTC
**Commit:** `4879ac01f49c8152418d839930814e0b5e55a5ca`
**Branch:** `main`
...
[17/42] [chromium] › e2e/memory-leak.spec.ts:207:3 › Offline Storage Persistence › navigator.storage.persist() prevents eviction
  2) [chromium] › e2e/memory-leak.spec.ts:110:3 › Memory Leak Detection › IndexedDB connections closed properly 
    ...
    Error: page.goto: Navigation to "http://localhost:4173/#/relatorios" is interrupted by another navigation to "http://localhost:4173/#/estoque"
    Call log:
      - navigating to "http://localhost:4173/#/relatorios", waiting until "load"
...
[18/42] [chromium] › e2e/network-error-handling.spec.ts:10:3 › Network Error Handling Scenarios › app loads successfully with slow network (3G)
[19/42] [chromium] › e2e/memory-leak.spec.ts:222:3 › Offline Storage Persistence › storage estimate available
...
[22/42] [chromium] › e2e/network-error-handling.spec.ts:64:3 › Network Error Handling Scenarios › fetch to missing endpoint returns handled error
  3) [chromium] › e2e/network-error-handling.spec.ts:64:3 › Network Error Handling Scenarios › fetch to missing endpoint returns handled error 

    Error: page.evaluate: Execution context was destroyed, most likely because of a navigation

      66 |     await page.waitForLoadState('networki
```
...
|------|----------|--------|
| 2026-08-07 20:27 UTC | CI report gerado automaticamente | `4879ac01f49c8152418d839930814e0b5e55a5ca` |
