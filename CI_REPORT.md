...
**Gerado:** 2026-08-05 17:25 UTC
**Commit:** `20fe3277177eab388ba7decb4b4b1a0539a42091`
**Branch:** `main`
...
```
5:25:31 PM [vite] warning: `esbuild` option was specified by "vite:react-babel" plugin. This option is deprecated, please use `oxc` instead.
5:25:31 PM [vite] warning: `optimizeDeps.esbuildOptions` option was specified by "vite:react-babel" plugin. This option is deprecated, please use `optimizeDeps.rolldownOptions` instead.
...
⎯⎯⎯⎯⎯⎯ Failed Suites 53 ⎯⎯⎯⎯⎯⎯
 ...
 FAIL  src/test/conflict.test.js [ src/test/conflict.test.js ]
 FAIL  src/test/constants.test.js [ src/test/constants.test.js ]
 FAIL  src/test/leader-election.test.js [ src/test/leader-election.test.js ]
 FAIL  src/test/sync-e2e.test.js [ src/test/sync-e2e.test.js ]
...
ReferenceError: TransformStream is not defined
 ...
 ❯ src/test/setup.js:7:1
      5| import { IDBFactory } from 'fake-indexeddb';
      6| import { beforeAll, afte
```
...
|------|----------|--------|
| 2026-08-05 17:25 UTC | CI report gerado automaticamente | `20fe3277177eab388ba7decb4b4b1a0539a42091` |
