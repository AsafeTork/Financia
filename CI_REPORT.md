...
**Gerado:** 2026-08-05 16:27 UTC
**Commit:** `cff35c3ab0bca9c811fa514354f37a1054c7765a`
**Branch:** `main`
...
```
4:27:05 PM [vite] warning: `esbuild` option was specified by "vite:react-babel" plugin. This option is deprecated, please use `oxc` instead.
4:27:05 PM [vite] warning: `optimizeDeps.esbuildOptions` option was specified by "vite:react-babel" plugin. This option is deprecated, please use `optimizeDeps.rolldownOptions` instead.
...
⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯[1/50]⎯
 ...
 FAIL  src/workers/color-extract.worker.test.js [ src/workers/color-extract.worker.test.j
```
...
|------|----------|--------|
| 2026-08-05 16:27 UTC | CI report gerado automaticamente | `cff35c3ab0bca9c811fa514354f37a1054c7765a` |
